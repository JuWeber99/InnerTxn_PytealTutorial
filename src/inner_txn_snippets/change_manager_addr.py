...
def inner_asset_manager_change_txn(asset_id: TealType.uint64, new_manager: TealType.bytes):
    """change the assets manager address"""
    return Seq([
        ...
        InnerTxnBuilder.SetFields({
            ...
            TxnField.config_asset_manager: new_manager,
            }),
